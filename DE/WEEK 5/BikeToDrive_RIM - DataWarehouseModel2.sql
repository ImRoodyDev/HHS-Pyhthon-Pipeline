...
-- SCD Type 1: Datum, Filiaal, Leverancier, Accessoire, Fabrikant, Fiets
-- SCD Type 2: Klant, Monteur (surrogate key + begintijd/eindtijd — eindtijd IS NULL = actueel)
PRAGMA foreign_keys = ON;

-- Dimensies (SCD Type 1)
CREATE TABLE Datum (
	datum DATE,
	jaar INT NOT NULL,
	maand INT NOT NULL,
...
CREATE TABLE Accessoire_Verkoop (
	...
	datum DATE NOT NULL,
	klant_sk INT NOT NULL,
	monteur_sk INT NOT NULL,
	...
	FOREIGN KEY(klant_sk) REFERENCES Klant(klant_sk),
	FOREIGN KEY(monteur_sk) REFERENCES Monteur(monteur_sk),
